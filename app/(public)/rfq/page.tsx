...
import { SpringMotion } from "@/app/components/ui/spring-motion";
            ...
            <SpringMotion>
              <div className="mb-10">
                <h1 className="text-4xl lg:text-5xl font-bold text-zinc-100 mb-4">
                  <TextAnimate animation="blurIn">Request for Quotation</TextAnimate>
                </h1>
                    ...
                    <MagnetButton
                      ...
                      className={`w-full py-4 ${
                        isSubmitting
                          ...
                          : "bg-gradient-to-r from-purple-600 to-indigo-600 border-purple-500/30 hover:border-purple-400/50"
                      }`}
                    >
                      {isSubmitting ? (
