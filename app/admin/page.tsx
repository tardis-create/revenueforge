...
import { AnimatedContent, CountUp, SpringButton, LoadingSkeleton } from '@/app/components'
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        // For now, use placeholder data for leads/quotes/revenue
        // In production, these would be separate API calls
        // Simulating API response for leads
        const leadsData: LeadStatusData[] = [
          { status: 'new', count: 12, color: 'bg-blue-500/60' },
          { status: 'contacted', count: 8, color: 'bg-amber-500/60' },
          { status: 'qualified', count: 5, color: 'bg-purple-500/60' },
          { status: 'proposal', count: 3, color: 'bg-cyan-500/60' },
          { status: 'won', count: 7, color: 'bg-emerald-500/60' },
          { status: 'lost', count: 2, color: 'bg-zinc-500/60' },
        ]

        // Simulating API response for revenue trend
        ...
        // Simulating API response for recent activity
        const activityData: ActivityItem[] = [
          {
            id: '1',
            action: 'create',
            resource_type: 'Product',
            details: 'Added "Industrial Pump Assembly"',
          ...
          },
          {
            ...
            action: 'update',
            resource_type: 'Lead',
            details: 'Updated status to "Qualified" for TechCorp',
          ...
          },
          {
            ...
            action: 'create',
            resource_type: 'Quote',
            details: 'Generated quote QT-2026-042',
          ...
          },
          {
            ...
            action: 'update',
            resource_type: 'Product',
            details: 'Updated pricing for Valve Set',
          ...
          },
          {
            ...
            action: 'create',
            resource_type: 'Lead',
            details: 'New lead from AquaFlow Systems',
          ...
          },
          {
            ...
            action: 'update',
            resource_type: 'Quote',
            details: 'Quote QT-2026-040 accepted',
          ...
          },
          {
            ...
            action: 'create',
            resource_type: 'Product',
            details: 'Added "Control Panel v2"',
          ...
          },
          {
            ...
            action: 'update',
            resource_type: 'Lead',
            details: 'Contacted EnergyPlus Ltd',
          ...
          },
          {
            ...
            action: 'create',
            resource_type: 'Quote',
            details: 'Generated quote QT-2026-038',
        ...
        const openQuotes = 8 // Would come from API
        const revenue = revenueData.reduce((sum, r) => sum + r.revenue, 0)
      ...
      <main className="relative max-w-7xl mx-auto px-6 lg:px-12 py-8 lg:py-12 pb-24 lg:pb-12">
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
          {loading ? (
            ...
            <>
              <BarChart data={leadStatusData} title="Leads by Status" />
              <LineChart data={revenueTrendData} title="Revenue Trend (6 Months)" />
            </>
          )}
        </div>
