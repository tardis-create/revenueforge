  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10">
        {/* Navigation */}
        <nav className="flex items-center justify-between px-6 py-6 lg:px-12 relative">
        ...
        {/* Footer */}
        <footer className="px-6 lg:px-12 py-8 pb-24 md:pb-8 border-t border-zinc-800/50">
